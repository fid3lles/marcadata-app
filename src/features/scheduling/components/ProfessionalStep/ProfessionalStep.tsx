...
export interface ProfessionalStepProps {
  /** Profissionais (disponíveis/indisponíveis) para o horário escolhido. */
...
/**
 * Etapa 3 do agendamento: escolha do profissional.
 *
 * Carrossel (scroll horizontal) com foto, nome e especialidade. Os
 * profissionais indisponíveis no horário aparecem, porém desabilitados.
 */
export function ProfessionalStep({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col animate-fade-in">
      <h2 className="text-lg font-bold text-slate-900">Quem vai te atender?</h2>
